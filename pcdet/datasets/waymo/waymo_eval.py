...
class OpenPCDetWaymoDetectionMetricsEstimator(tf.test.TestCase):
    ...
    def waymo_evaluation(self, prediction_infos, gt_infos, class_name, distance_thresh=100, fake_gt_infos=True):
        ...
        print("debug before generate_waymo_type_results pd")
        ...
        print("debug before generate_waymo_type_results gt")
        ...
        print("debug after generate_waymo_type_results")
        ...
        print("debug after mask_by_distance pd")
        ...
        print("debug after mask_by_distance gt")
