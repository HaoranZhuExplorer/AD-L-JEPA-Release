...
def eval_single_ckpt(model, data_loader, args, eval_output_dir, logger, epoch_id, dist_test=False):
    # load checkpoint
...
def main():
    ...
    with torch.no_grad():
        eval_single_ckpt(model, val_loader, args, eval_output_dir, logger, epoch_id, dist_test=dist_test)
